var htmx = (function () {
  ...
  function me(e, t, n, r) {
    if (k(t)) {
      return { target: te().body, event: K(e), listener: t, options: n };
    } else {
      return { target: S(e), event: K(t), listener: n, options: r };
    }
  }
  function ye(t, n, r, o) {
    Gn(function () {
  ...
  function Re(e) {
    ie(y(e, "[hx-preserve], [data-hx-preserve]"), function (e) {
      const t = a(e, "id");
  ...
  function gt(l, u, e, c, f) {
    ...
    ie(t, function (i) {
        ...
        if (t.handledFor.indexOf(l) < 0) {
          ...
          if (c.throttle > 0) {
            if (!a.throttle) {
              ae(l, "htmx:trigger");
              u(l, e);
              a.throttle = x().setTimeout(function () {
                a.throttle = null;
              }, c.throttle);
            }
          } else if (c.delay > 0) {
            a.delayed = x().setTimeout(function () {
              ae(l, "htmx:trigger");
              u(l, e);
            }, c.delay);
          } else {
      ...
      e.listenerInfos.push({ trigger: c.trigger, listener: s, on: i });
  ...
  function Kt(e) {
    ...
    ie(y(n, "[data-disabled-by-htmx]"), function (e) {
